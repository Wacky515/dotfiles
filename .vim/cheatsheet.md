...
- \<Leader\>md: カレントバッファをブラウザで表示(Markdown 用)
...
- \<Leader\>dj: カーソル位置を英和辞典検索
- \<Leader\>de: カーソル位置を和英辞典検索
...
- \<Leader\>dw: カーソル位置を Wiki で検索
- \<Leader\>da: カーソル位置の単語をスペースアルクで検索
- ,uc: "Unite codic" 起動
